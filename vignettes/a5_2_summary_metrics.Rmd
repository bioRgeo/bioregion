...
compute three core terms, from which occurrence-based metrics are derived.
...
`cluster_on = "site"` (or `cluster_on = "both"`). `cluster_on = "site"` means that 
...
Based on all these metrics, it is also possible to derive aggregated metrics.  
