...
```{r}
contrib_kmeans <- contribution(vege_nhclu_kmeans, vegemat, indices = "rho")
contrib_hclu <- contribution(vege_hclu_hierarclust, vegemat, indices = "rho")
contrib_netclu <- contribution(vege_netclu_walktrap, vegemat, indices = "rho")
