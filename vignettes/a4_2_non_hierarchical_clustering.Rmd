...
in `bioRgeo` relying on non-hierarchical clustering start with the prefix
`nhclu_`.
<br>
...
the `bioRgeo` conceptual diagram:  
...
clustering analyses with `bioRgeo`. Such analysis usually has the following
steps.  
<br>
...
`bioRgeo` to perform non-hierarchical clustering. These functions are based on
centroid-based algorithms  ([Kmeans](https://biorgeo.github.io/bioRgeo/reference/nhclu_kmeans.html)
and
[PAM](https://biorgeo.github.io/bioRgeo/reference/nhclu_pam.html)
) or density-based algorithms 
([DBSCAN](https://biorgeo.github.io/bioRgeo/reference/nhclu_dbscan.html)).  
<br>
*3. Determining the optimal number of clusters*  
The two functions
[`partition_metrics()`](https://biorgeo.github.io/bioRgeo/reference/partition_metrics.html)
and
[`find_optimal_n()`](https://biorgeo.github.io/bioRgeo/reference/find_optimal_n.html)
...
<br>
The function to compute K-means clustering in `bioRgeo` is `nhclu_kmeans()`.
...
Like for all other functions of the `bioRgeo` package, the `class` of the 
object is specific for the package (here `bioRgeo.clusters`) and it contains
