...
[`combine_bioregion_pairwise()`](https://bioRgeo.github.io/bioregion/reference/combine_bioregion_pairwise.html) to combine two `bioregion.pairwise.metric` objects and/or compute new pairwise 
...
dissim <- combine_bioregion_pairwise(primary_metrics = dissim1,
