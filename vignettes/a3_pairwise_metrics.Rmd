...
The function [similarity](https://bioregion.github.io/bioregion/reference/similarity.html) 
...
pair of sites. The function [similarity](https://bioregion.github.io/bioregion/reference/similarity.html) 
...
The main advantage of the [similarity](https://bioregion.github.io/bioregion/reference/similarity.html) 
...
The [dissimilarity](https://bioregion.github.io/bioregion/reference/dissimilarity.html) 
function is very similar, with the sole exception that it computes the 
dissimilarity version of the available metrics. The functions [dissimilarity_to_similarity](https://bioregion.github.io/bioregion/reference/dissimilarity_to_similarity.html) and [similarity_to_dissimilarity](https://bioregion.github.io/bioregion/reference/dissimilarity_to_similarity.html)
