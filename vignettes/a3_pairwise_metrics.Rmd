...
or outputs from other packages into a `bioregion.pairwise.metric` object  
...
but also outputs from several functions provided by the packages 
[adespatial](https://cran.r-project.org/package=adespatial), 
[betapart](https://cran.r-project.org/package=betapart), 
[ecodist](https://cran.r-project.org/package=ecodist) and 
[vegan](https://cran.r-project.org/package=vegan) described above.

This includes the outputs of `beta.div` and `beta.div.comp` from the 
[adespatial](https://cran.r-project.org/package=adespatial) package.
...
`beta.pair`, `beta.pair.abund`, `betapart.core` and `betapart.core.abund` from 
the [betapart](https://cran.r-project.org/package=betapart) package.
...
`distance` and `bcdist` from the 
[ecodist](https://cran.r-project.org/package=ecodist) package.
...
and finally `vegdist` and `designdist` from 
[vegan](https://cran.r-project.org/package=ecodist).
