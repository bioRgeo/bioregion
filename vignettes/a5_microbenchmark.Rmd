...
vignette: >
  %\VignetteIndexEntry{5. Microbenchmark}
...
```{r}
data("benthicmat")
benthicdissim <- dissimilarity(benthicmat, metric = "all")
data("benthicdf")
```
...
mbm <- suppressMessages(
  microbenchmark(
    ...
    # benthic vertebrates
    benthic_nhclu_dbscan = nhclu_dbscan(dissimilarity = benthicdissim,
                                        index = "Simpson", plot = FALSE),
    benthic_nhclu_kmeans = nhclu_kmeans(benthicdissim, n_clust = 2:10,
                                        index = "Simpson"),
    benthic_nhclu_pam = nhclu_pam(benthicdissim, n_clust = 2:10, index = "Simpson"),
    benthic_hclu_hierarclust = hclu_hierarclust(dissimilarity = benthicdissim,
                                                n_clust = 5),
    benthic_hclu_optics = hclu_optics(benthicdissim, index = "Simpson"),
    benthic_netclu_beckett = netclu_beckett(benthicdf),
    benthic_netclu_greedy = netclu_greedy(benthicdf),
    benthic_netclu_labelprop = netclu_labelprop(benthicdf),
    benthic_netclu_leadingeigen = netclu_leadingeigen(benthicdf),
    benthic_netclu_oslom = netclu_oslom(benthicdf),
    benthic_netclu_walktrap = netclu_walktrap(benthicdf),
    benthic_netclu_infomap = netclu_infomap(benthicdf),
    benthic_netclu_louvain = netclu_louvain(benthicdf),
...
mbm_plot$dataset <- ifelse(
  ...
  ifelse(grepl("benthic_", mbm_plot$expr),
         paste0("Benthic (", nrow(benthicmat) * ncol(benthicmat), " cells)"),
