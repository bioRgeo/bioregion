...
Top-down approach of hierarchical clustering instead of the bottom-up approach.
...
of breaks to identify on the curve. Note that such a model likely 
requires a minimum number of points to find an appropriate number of 
clusters. In our example here, we make 100 cuts in the tree to have enough
values.

```{r, cache = TRUE}
tree5 <- cut_tree(tree4,
                  cut_height = seq(0, 0.67, # We cut the tree 100 times from 0 to 0.67 
