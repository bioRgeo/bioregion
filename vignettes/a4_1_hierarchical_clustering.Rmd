...
minimum value of the metrics, or, experimentally, using a MARS (multiple 
adaptive regression splines) model to identify cutoff points in the curve.
...
large cutoffs like Holt et al. (2013) and end up with a reasonable number of 
