...
with the diferent algorithms available in `bioRgeo`.
<br>
Using one of the dataset coming along with `bioRgeo`, we show three strategies
...
which is of `bioRgeo.clusters` class, and the spatial distribution of sites,
stored in `fishsf`.
...
```{r}
all_long_sf <- left_join(all_long,
