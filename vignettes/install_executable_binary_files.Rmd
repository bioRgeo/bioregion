...
[netclu_louvain](https://biorgeo.github.io/bioRgeo/reference/netclu_louvain.html)
and [netclu_oslom](https://biorgeo.github.io/bioRgeo/reference/netclu_oslom.html)
accordingly. The second parameter **infomap_version**  
indicating the Infomap version(s) to install. Only the Infomap version 2.1.0 and 
2.6.0 are available for now.
...
* The OpenMP versions of Infomap require **libomp-dev** on Ubuntu (**sudo apt-get install libomp-dev**) 
and **libomp** on macOS (install [Homebrew](https://brew.sh){:target="_blank"} and run 
**brew install libomp**).
