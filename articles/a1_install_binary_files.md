...
```
    ...
    ## The folder has been successfully downloaded to /tmp/RtmpcMxqJy.
    ...
    ## The folder has been successfully unzipped in /tmp/RtmpcMxqJy.
    ...
    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.1.0/infomap_omp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.1.0/infomap_noomp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.6.0/infomap_omp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.6.0/infomap_noomp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.7.1/infomap_omp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.7.1/infomap_noomp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.8.0/infomap_omp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/INFOMAP/2.8.0/infomap_noomp_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/LOUVAIN/convert_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/LOUVAIN/louvain_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/OSLOM/oslom_dir_lin as program: denied.

    ## Permission to execute /tmp/RtmpcMxqJy/bin/OSLOM/oslom_undir_lin as program: denied.
    ...
    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.1.0/infomap_omp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.1.0/infomap_noomp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.6.0/infomap_omp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.6.0/infomap_noomp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.7.1/infomap_omp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.7.1/infomap_noomp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.8.0/infomap_omp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/INFOMAP/2.8.0/infomap_noomp_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/LOUVAIN/convert_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/LOUVAIN/louvain_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/OSLOM/oslom_dir_lin can now be executed as progam.

    ## Automatic change of permission succeed, /tmp/RtmpcMxqJy/bin/OSLOM/oslom_undir_lin can now be executed as progam.
