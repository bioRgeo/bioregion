...
[![Codecov test coverage](https://codecov.io/gh/bioRegio/bioregion/branch/master/graph/badge.svg)](https://app.codecov.io/gh/bioRgeo/bioregion?branch=master)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/bioregion)](https://cran.r-project.org/package=bioregion) 
[![rstudio mirror downloads](http://cranlogs.r-pkg.org/badges/grand-total/bioregion)](http://r-pkg.org/pkg/bioregion) 
<!-- badges: end -->
