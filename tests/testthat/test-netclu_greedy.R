...
test_that("number of columns in output", {
  clust1 <- netclu_greedy(net)
  
  expect_equal(clust1$name, "netclu_greedy")
  ...
  expect_equal(clust2$name, "netclu_greedy")
