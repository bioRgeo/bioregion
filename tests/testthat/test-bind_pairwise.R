...
test_that("valid output", {
  ...
  pair <- bind_pairwise(primary_metrics = similarity(comat, metric = "abc"), 
  ...
  pair <- bind_pairwise(similarity(comat, metric = "abc"), 
...
test_that("invalid inputs", {
  ...
  expect_error(
    bind_pairwise(primary_metrics = 1,
                               secondary_metrics = 1,
                               new_metrics = NULL),
    "^primary_metrics should be a bioregion.pairwise object")
  
  expect_error(
    bind_pairwise(primary_metrics = simil0,
                               secondary_metrics = 1,
                               new_metrics = NULL),
    "^primary_metrics is a bioregion.pairwise object but it has not")
  
  expect_error(
    bind_pairwise(primary_metrics = simil00,
                               secondary_metrics = 1,
                               new_metrics = NULL),
    "^primary_metrics is a bioregion.pairwise object but it has not")
  ...
  expect_error(
    bind_pairwise(primary_metrics = simil1,
                               secondary_metrics = 1,
                               new_metrics = NULL),
    "^secondary_metrics should be a bioregion.pairwise object")
  
  expect_error(
    bind_pairwise(primary_metrics = simil1,
                               secondary_metrics = simil0,
                               new_metrics = NULL),
    "^secondary_metrics is a bioregion.pairwise object but it has not")
