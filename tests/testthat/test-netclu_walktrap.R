...
test_that("number of columns in output", {
  clust1 <- netclu_walktrap(net)
  
  expect_equal(clust1$name, "netclu_walktrap")
  ...
  expect_equal(clust2$name, "netclu_walktrap")
