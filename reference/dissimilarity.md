...
containing one or several dissimilarity metrics between pairs of sites.
The first two columns represent the pairs of sites. There is one column
per similarity metric provided in `metric` and `formula`, except for the
...
will compute the Simpson and Bray-Curtis dissimilarity metrics,
...
and Biogeography*, 21(12), 1223–1232.
