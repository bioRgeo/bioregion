...
#> 
#> Final tree has a 0.5026 cophenetic correlation coefficient with the initial dissimilarity matrix
...
#>   ..$ final.tree.coph.cor: num 0.503
#>   ..$ final.tree.msd     : num 0.00277
