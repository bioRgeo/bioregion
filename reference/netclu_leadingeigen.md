...
based on the leading eigenvector of the community matrix.
...
This function is based on the leading eigenvector of the community
matrix (Newman, 2006) as implemented in the
