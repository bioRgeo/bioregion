...
similarity_to_distance <- function(similaritydata) {
  ...
  if (attr(similaritydata, "type") == "distance") {
    stop("similaritydata is already composed of distance indices. If you want to convert it to similarity, use distance_to_similarity()")
  }
